package com.example.act_10_gridview_angel;
...
public class BaseAdapterPersonalizado extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_grid_personalizado, null);
    ...
    static class ViewHolder {
        ...
        TextView textViewVolumenCilindro;
        LinearLayout layoutPerimetroArea;
    }
